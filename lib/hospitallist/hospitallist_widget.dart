...
class HospitallistWidget extends StatefulWidget {
  const HospitallistWidget({Key? key}) : super(key: key);

  @override
  _HospitallistWidgetState createState() => _HospitallistWidgetState();
}
