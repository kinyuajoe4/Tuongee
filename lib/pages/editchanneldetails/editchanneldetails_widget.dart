...
import 'editchanneldetails_model.dart';
export 'editchanneldetails_model.dart';

class EditchanneldetailsWidget extends StatefulWidget {
  const EditchanneldetailsWidget({
    super.key,
    this.userProfile,
    this.channeldocpassed,
  });

  final DocumentReference? userProfile;
  final ChannelsRecord? channeldocpassed;

  @override
  State<EditchanneldetailsWidget> createState() =>
      _EditchanneldetailsWidgetState();
}

class _EditchanneldetailsWidgetState extends State<EditchanneldetailsWidget> {
  late EditchanneldetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditchanneldetailsModel());

    _model.yourNameTextController ??=
        TextEditingController(text: widget.channeldocpassed?.chanelname);
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    await widget.channeldocpassed!.reference
