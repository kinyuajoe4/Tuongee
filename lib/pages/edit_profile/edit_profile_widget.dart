        ...
        return Title(
            ...
            child: Scaffold(
              ...
              body: Stack(
                children: [
                  Align(
                    alignment: AlignmentDirectional(0.00, -4.44),
                    child: Container(
                      width: 370.0,
                      height: 2000.0,
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                  validator: _model
                                      .specialityController1Validator
                                      .asValidator(context),
                                ),
                              ),
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                  validator: _model
                                      .specialityController2Validator
                                      .asValidator(context),
                                ),
                              ),
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                  validator: _model
                                      .yourscheduleControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  maxLines: 3,
                                  validator: _model
                                      .yourAilmentsControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    await editProfileUsersRecord.reference
                                      ...
                                      ailments:
                                          _model.yourAilmentsController.text,
                                      userSex: _model.radioButtonValue,
                                      photoUrl: _model.uploadedFileUrl,
                                      speciality:
                                          _model.specialityController1.text,
                                      locality:
                                          _model.specialityController2.text,
                                      schedule:
                                          _model.yourscheduleController.text,
                                    ));
                                    context.pop();
                                  },
                                  text: 'Save Changes',
