...
import 'homecarepage_model.dart';
export 'homecarepage_model.dart';

class HomecarepageWidget extends StatefulWidget {
  const HomecarepageWidget({Key? key}) : super(key: key);

  @override
  _HomecarepageWidgetState createState() => _HomecarepageWidgetState();
}

class _HomecarepageWidgetState extends State<HomecarepageWidget>
    with TickerProviderStateMixin {
  late HomecarepageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomecarepageModel());
